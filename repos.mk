...
$(eval $(call build_repo,astute,https://github.com/Mirantis/astute.git,origin/astute-cleanup))
$(eval $(call build_repo,nailgun,https://github.com/Mirantis/fuelweb.git,origin/fuelweb-cleanup))
$(eval $(call build_repo,fuel,https://github.com/Mirantis/fuel.git,fuel-3.1))
$(eval $(call build_repo,ostf_tests,https://github.com/Mirantis/fuel-ostf-tests.git,origin/master))
$(eval $(call build_repo,ostf_plugin,https://github.com/Mirantis/fuel-ostf-plugin.git,origin/master))
